...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        'group/card gap-(--card-spacing) py-(--card-spacing) text-card-foreground has-data-[slot=card-footer]:pb-0 data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl flex flex-col overflow-hidden rounded-2xl bg-white text-sm shadow-sm [--card-spacing:--spacing(3)] has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(3)]',
        className,
      )}
      {...props}
    />
